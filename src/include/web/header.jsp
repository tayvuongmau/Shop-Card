...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="position: fixed; z-index: 1; width: 100%;">
    <div class="container px-4 px-lg-5">
        <a style="margin: 0%; padding: 0%; text-transform: uppercase; text-align: center;" class="navbar-brand" href="#"><img src="${pageContext.request.contextPath}/logo/logo1.png" width="15%"/><h4>Defense of the Ancients</h4></a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4" style="margin-top: 2%;">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="#">Card Hero Streng</a></li>
                        <li><a class="dropdown-item" href="#">Card Hero Intelligent</a></li>
                        <li><a class="dropdown-item" href="#">Card Hero Agility</a></li>
                    </ul>
                </li>
                <li class="nav-item">
